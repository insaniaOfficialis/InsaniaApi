...
namespace Data.Migrations
{
    ...
    [Migration("20231103091918_UpdInformationArticleId_1")]
    partial class UpdInformationArticleId_1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.General.File.FileInformationArticleDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("InformationArticleDetailId")
                        .HasColumnType("bigint")
                        .HasColumnName("information_article_detail_id")
                    ...
                    b.HasIndex("InformationArticleDetailId");

                    b.ToTable("un_files_information_articles_details", t =>
                        {
                            t.HasComment("Связь файлов с детальными частями информационных статей");
                        });
                });

            modelBuilder.Entity("Domain.Entities.General.File.FileNewsDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("NewsDetailId")
                        .HasColumnType("bigint")
                        .HasColumnName("news_detail_id")
                        .HasComment("Ссылка на детальную часть новости");
                    ...
                    b.HasIndex("NewsDetailId");

                    b.ToTable("un_files_news_details", t =>
                        {
                            t.HasComment("Связь файлов с детальными частями новостей");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Identification.RoleAcccessRight", b =>
                {
                    ...
                    b.Property<long>("AccessRightId")
                        ...
                        .HasComment("Ссылка на право доступа");
                    ...
                    b.ToTable("un_roles_access_rights", t =>
                        {
                            t.HasComment("Связь ролей с правами доступа");
                        });
                });

            modelBuilder.Entity("Domain.Entities.Informations.InformationArticle", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("re_information_articles", t =>
                        {
                            t.HasComment("Информационные статьи");
                        });
                });

            modelBuilder.Entity("Domain.Entities.Informations.InformationArticleDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("InformationArticleId")
                        .HasColumnType("bigint")
                        .HasColumnName("information_article_id")
                        .HasComment("Ссылка на информационную статью");
                    ...
                    b.HasIndex("InformationArticleId");

                    b.ToTable("re_information_articles_details", t =>
                        {
                            t.HasComment("Детальная часть информационных статей");
                        });
                });

            modelBuilder.Entity("Domain.Entities.Informations.News", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("TypeId")
                        .HasColumnType("bigint")
                        .HasColumnName("type_id")
                        .HasComment("Ссылка на тип новости");
            ...
            modelBuilder.Entity("Domain.Entities.Informations.NewsDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("re_news_details", t =>
                        {
                            t.HasComment("Детальная часть новостей");
                        });
                });

            modelBuilder.Entity("Domain.Entities.Informations.NewsType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("dir_news_types", t =>
                        {
                            t.HasComment("Типы новостей");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.General.File.FileInformationArticleDetail", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Informations.InformationArticleDetail", "InformationArticleDetail")
                        .WithMany()
                        .HasForeignKey("InformationArticleDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("File");

                    b.Navigation("InformationArticleDetail");
                });
            ...
            modelBuilder.Entity("Domain.Entities.General.File.FileNewsDetail", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Informations.NewsDetail", "NewsDetail")
                        .WithMany()
                        .HasForeignKey("NewsDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Identification.RoleAcccessRight", b =>
                {
                    b.HasOne("Domain.Entities.Identification.AccessRight", "AccessRight")
                        .WithMany()
                        .HasForeignKey("AccessRightId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.Identification.Role", "Role")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.Informations.InformationArticleDetail", b =>
                {
                    b.HasOne("Domain.Entities.Informations.InformationArticle", "InformationArticle")
                        .WithMany()
                        .HasForeignKey("InformationArticleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("InformationArticle");
                });

            modelBuilder.Entity("Domain.Entities.Informations.News", b =>
                {
                    b.HasOne("Domain.Entities.Informations.NewsType", "Type")
                        .WithMany()
                        .HasForeignKey("TypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Informations.NewsDetail", b =>
                {
                    b.HasOne("Domain.Entities.Informations.News", "News")
                        .WithMany()
